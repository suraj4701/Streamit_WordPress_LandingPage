...
class CustomReporter {
    ...
    async onEnd(result) {
        ...
        console.log(`\n--- Test Summary ---`);
        console.log(`Project: Streamit WordPress Landing Page`);
    ...
    async sendReportEmail(overallStatus, passedCount, failedCount) {
        ...
        let emailHtmlBody = `
            <p>Dear Team,</p>
            <p>Here is the automated Playwright test report summary for <strong>Streamit WordPress Landing Page</strong> as of ${new Date().toLocaleString('en-IN', { timeZone: 'Asia/Kolkata' })}.</p>
            <hr>
            <h2>Test Summary</h2>
